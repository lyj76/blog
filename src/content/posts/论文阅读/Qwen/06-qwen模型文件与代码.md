...
> 承接 [[论文阅读/qwen/01-qwen主线]] 与 [[论文阅读/qwen/03-qwen-decoder-block]]：01 给了 7 个权重矩阵的拓扑，02 拆了整机架构，03 拆了单层算子。本篇把数学符号落到磁盘——**config 里的每个数字决定什么结构、权重在文件里长什么样、源码怎么对应公式**。索引见 [[论文阅读/qwen/00-qwen阅读地图]]。
